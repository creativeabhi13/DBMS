...
?>
	...
	<head>
		...
		<link rel="stylesheet" href="/css/pricing.css"> </head>
		...
		<div class="col-md-6 col-12 mx-auto contact_form p-3" id="form">
			...
			<form action=connect2.php method=post>
				<div class="form-group">
					...
					<input type="number" class="form-control" id="name" name="tno" placeholder="Enter the Tenant Name"> </div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="email" name="staff_sal" placeholder="Enter The Phone Number"> </div>
				<div class="form-group">
					<label for="type">Miscellaneous Charges</label>
					<input type="number" class="form-control" id="subject" name="misc_charges" placeholder="Enter The Type "> </div>
				<div class="form-group">
					<label for="block">Repair Charges</label>
					<input type="number" class="form-control" id="subject" name="repaircharges" placeholder="Enter The Block"> </div>
				<div class="form-group">
					<label for="rent">Rent</label>
					<input type="number" class="form-control" id="subject" name="rent" placeholder="Enter The Rent "> </div>
				<div class="form-group">
					<label for="date">Date (YYYY-MM-DD)</label>
					<input type="text" class="form-control" id="subject" name="date" placeholder="Enter The Date(YYYY-MM-DD) "> </div>
