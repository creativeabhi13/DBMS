...
?>
	...
	<head>
		...
		<link rel="stylesheet" href="/css/client.css"> </head>

	<body>
		<div class="nav">
			<nav class="navbar">
				<div class="logo"> <a href="index.php" target="blank">Abhishek & Aditya Group</a> </div>
				<ul class="nav-links">
					...
					<div class="menu">
						...
						<li class="services" target="blank"> <a href="apartment.php" target="blank">Apartment</a> </li>
					</div>
		</div>
		</ul>
		</nav>
		...
		<div class="col-md-6 col-12 mx-auto contact_form p-3" id="form">
			...
			<form action=connect5.php method=post>
				<div class="form-group">
					...
					<input type="name" class="form-control" id="name" name="tname" placeholder="Enter the Tenant Name"> </div>
				<div class="form-group">
					<label for="tno">Tenant Number</label>
					<input type="number" class="form-control" id="name" name="tno" placeholder="Enter The Tenant Number"> </div>
				<div class="form-group">
					<label for="aptno">Apartment Number</label>
					<input type="number" class="form-control" id="name" name="aptno" placeholder="Enter The Apartment Number"> </div>
				<div class="form-group">
					<label for="tphone">Phone</label>
					<input type="number" class="form-control" id="email" name="tphone" placeholder="Enter The Phone Number"> </div>
				<div class="form-group">
					<label for="type">Type</label>
					<input type="text" class="form-control" id="subject" name="type" placeholder="Enter The Type "> </div>
				<div class="form-group">
					<label for="block">Block</label>
					<input type="number" class="form-control" id="subject" name="block" placeholder="Enter The Block"> </div>
				<div class="form-group">
					<label for="aptno">Dependent Name</label>
					<input type="name" class="form-control" id="name" name="dname" placeholder="Enter The Dependent Name"> </div>
				<div class="form-group">
					<label for="dphone">Dependent Phone Number</label>
					<input type="number" class="form-control" id="" name="dphone" placeholder="Enter The Dependent Phone Number"> </div>
							...
							<div class="col-md-6 col-12 mx-auto contact_form p-3">
								...
								<form action=connect3.php method=post>
									<div class="form-group">
										...
										<input type="name" class="form-control" id="name" name="name" placeholder="Enter Your Name"> </div>
									<div class="form-group">
										<label for="email">Email</label>
										<input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email"> </div>
									<div class="form-group">
										<label for="subject">Subject</label>
										<input type="text" class="form-control" id="subject" name="subject" placeholder="Enter The Subject"> </div>
									<div class="form-group">
										<label for="message">Message</label>
										<textarea class="form-control" id="message" cols="30" rows="10" name="message" placeholder="Enter The Message"></textarea>
									</div>
									<button>Submit</button>
								</form>
							</div>
						...
						<div class="col-md-10 col-11 mx-auto">
							<div class="row text-center">
								...
								<div class="col-md-4 col-11">
									<h5>Follow US</h5>
									<ul>
										<a href="https://www.facebook.com/creativeabhi13" target="blank"> <img src="image/fb.png" width="30px" height="30px" alt=""> </a>
										<a href="https://www.instagram.com/creativeabhi13" target="blank"> <img src="image/insta.png" width="30px" height="30px" alt=""> </a>
										<a href="https://www.youtube.com/creativeabhi13" target="blank"> <img src="image/youtube.png" width="40px" height="40px" alt=""> </a>
										<a href="https://www.linkedin.com/in/creativeabhi13/" target="blank"> <img src="image/linkedin.png" width="40px" height="40px" alt=""> </a>
										<a href="https://wa.me/+918603944898" target="blank"> <img src="image/wha.png" width="40px" height="40px" alt=""> </a>
									</ul>
								</div>
								<div class="col-md-4 col-11">
									<h5>Contact US</h5>
